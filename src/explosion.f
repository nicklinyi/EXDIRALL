...
************************************************************************
      COMPLEX FUNCTION PTAU*16(P,DPDT,TAU,X,PPS,TPS)
...
************************************************************************
      REAL FUNCTION NULFUB*8(F,P,NP,X1,X2,FXERR)
C********************************************************************
