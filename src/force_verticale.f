...
C        ***********************************************************
C        comment out by YI LIN, not used in the main program 
c        double precision FUNCTION myD01AHF(A,B,RA,NP,RE,F,NL,IF)

c       implicit double precision (a-h,o-z)

c       double precision  A,B,RA,RE,F
c       INTEGER NP,NL,IF
c       EXTERNAL F

c       double precision w(10000),iw(10000)
